/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 26f1e0ee15c3fa4be022dc1e3d96a8a6)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	PRIVATE_ASSETS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	TRIP_ROOMS: DurableObjectNamespace /* TripRoom */;
}
