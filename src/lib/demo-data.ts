...
export interface WorkspaceCity { id: string; name: string; country: string; nights: number; timeZone: string; lat: number; lon: number; image?: string; stayStatus?: StayStatus; lodgingName?: string }
export interface WorkspaceIdea { id: string; name: string; detail: string; cityId: string; priority: IdeaPriority; votes: number; userVoted?: boolean; image?: string; imageAttribution?: { label: string; url: string }; scheduled: boolean; lat: number; lon: number }
export interface WorkspaceItem { id: string; dayId: string; title: string; subtitle: string; start?: string; duration?: number; durationSource?: DurationSource; kind: "activity" | "placeholder"; placeholderType?: PlaceholderType; reservation?: ReservationStatus; cost?: string; ideaId?: string; health?: PlaceHealth; healthCheckedAt?: string }
export interface WorkspaceDay { id: string; ordinal: number; date: string; cityId: string; title: string }

export const demoCities: WorkspaceCity[] = [
...
export const demoDays: WorkspaceDay[] = [
...
export const demoIdeas: WorkspaceIdea[] = [
...
export const demoItems: WorkspaceItem[] = [
