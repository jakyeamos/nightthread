...
Nightthread is a collaborative planning workspace for collecting places, voting on ideas, arranging days, preserving placeholders, and understanding a trip's route at a glance. Release 1 succeeds when a group can plan a complete trip without returning to a cluttered general-purpose itinerary tool.

## Brand Personality

Cinematic, composed, and exploratory. Nightthread should feel like opening a beautifully art-directed atlas after dark: calm enough for careful decisions, vivid enough to make the trip feel real, and never precious at the expense of usability.
